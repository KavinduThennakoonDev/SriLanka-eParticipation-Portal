...
export default function PaginationRounded() {
  ...
  useEffect(() => {
    const fetchAllContents = async () => {
      try {
        const res = await axios.get(`${API_BASE_URL}/content/notcontents`);
    ...
    <>
      <div className="content-topic">
        <ul className="public-style-content-subtopic">
          ...
          <li>
            <a href="">
            Closed public Consultation <SlArrowRight />
            </a>
          </li>
          <li>
            <a href="/ContentViews">
              <b>Closed public Consultation</b>
            </a>
          </li>
        </ul>
        <h1 className="topic-style-public">Closed Public Consultation</h1>
      </div>
      <br />
      <div>
        <Search />
